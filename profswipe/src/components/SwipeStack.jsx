...
function Modal({ prof, onClose }) {
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
      ...
      <div style={{ position: 'relative', backgroundColor: '#191e24', border: '1px solid #2a323c', borderRadius: 20, width: '100%', maxWidth: 500, maxHeight: '90vh', overflowY: 'auto', padding: 24, zIndex: 1 }}>
        ...
        <div className="flex gap-4 items-start mb-4">
          ...
          <div>
            ...
            <p style={{ color: '#6b7280', fontSize: 13, margin: 0 }}>{prof.department} · {prof.level}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          {[
            ...
            <div key={s.label} style={{ backgroundColor: '#1d232a', borderRadius: 12, padding: 12 }}>
              <p style={{ color: '#6b7280', fontSize: 11, margin: '0 0 4px' }}>{s.label}</p>
        ...
        <p style={{ color: '#6b7280', fontSize: 12, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 }}>Reviews</p>
        {prof.reviews.map((r, i) => (
          <div key={i} style={{ backgroundColor: '#1d232a', borderRadius: 12, padding: 12, marginBottom: 8, fontSize: 14, fontStyle: 'italic', color: '#a6adbb' }}>
            "{r}"
          </div>
        ))}
      </div>
  ...
  if (index >= professors.length) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4 text-center">
        ...
        <p style={{ color: '#6b7280' }}>You went through all {professors.length} professors.</p>
  ...
  return (
    <div className="flex flex-col items-center gap-6">
      ...
      <div style={{ width: '100%', maxWidth: 360 }}>
        ...
        <div style={{ backgroundColor: '#2a323c', borderRadius: 999, height: 6 }}>
      ...
      <div style={{ position: 'relative', width: 360, height: 520 }}>
        {index + 1 < professors.length && (
          <div style={{ position: 'absolute', inset: 0, backgroundColor: '#191e24', border: '1px solid #2a323c', borderRadius: 24, transform: 'scale(0.95) translateY(12px)', zIndex: 0 }} />
        )}
      ...
      <div className="flex gap-6 items-center">
        {[
          ...
          { fn: handleTopPick, label: <FaStar />, bg: '#fbbd23', border: 'none', color: '#1d232a', title: 'Top Pick' },
